...
public class Controls {
    ...
    void makeControls() {
        ...
        int y = 0;
        control.addSlider("n", 1, 20000, parent.n, 10, y += 10, 256, 9).setWindow(w);
        control.addSlider("dofRatio", 1, 200, parent.dofRatio, 10, y += 10, 256, 9)
                .setWindow(w);
        control.addSlider("neighborhood", 1, parent.width * 2, parent.neighborhood, 10,
                y += 10, 256, 9).setWindow(w);
        control.addSlider("speed", 0, 100, parent.speed, 10, y += 10, 256, 9)
                .setWindow(w);
        control.addSlider("viscosity", 0, 1, parent.viscosity, 10, y += 10, 256, 9)
                .setWindow(w);
        control.addSlider("spread", 50, 200, parent.spread, 10, y += 10, 256, 9)
                .setWindow(w);
        control.addSlider("independence", 0, 1, parent.independence, 10, y += 10, 256,
                9).setWindow(w);
        control.addSlider("rebirth", 0, 100, parent.rebirth, 10, y += 10, 256, 9)
                .setWindow(w);
        control.addSlider("rebirthRadius", 1, parent.width, parent.rebirthRadius, 10,
                y += 10, 256, 9).setWindow(w);
        control.addSlider("turbulence", 0, 4, parent.turbulence, 10, y += 10, 256, 9)
                .setWindow(w);
